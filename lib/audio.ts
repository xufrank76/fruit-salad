...
// Encodes an AudioBuffer as a 16-bit PCM WAV Blob. Recordings captured via
// startMicCapture/sliceCaptureToBuffer only ever exist as an AudioBuffer (no
// MediaRecorder Blob in that path), so this is what turns a take into
// something that can be uploaded as a file.
